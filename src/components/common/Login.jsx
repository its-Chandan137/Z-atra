  ...
  return (
    <div className="container1">
        <div className="nav flex items-center justify-center">
            <div>
                <CustomeNavLink href='/Home'><img src='../image/product/Z-atra.png' alt="L-o-g-o" className='h-10 cursor-pointer'/></CustomeNavLink>
            </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="max-w-sm mx-auto" noValidate>
            ...
            <div>
                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">New to the app ? <a onClick={()=>navigate("/Register")}  className="text-blue-600 hover:underline dark:text-blue-500"> Register</a></label>
            </div>
